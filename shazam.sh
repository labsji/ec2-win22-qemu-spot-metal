...
FSTAB
  ...
  echo "Fresh setup complete."
    ...
    [ -z "${INSTANCE_ID:-}" ] && die "Launch failed. c5.metal spot unavailable in $REGION. Try again later or check spot vCPU quota (need 96): https://console.aws.amazon.com/servicequotas"
